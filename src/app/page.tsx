      ...
      <section className="bg-gradient-to-r from-primary-color to-secondary-color text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-5xl font-bold mb-6">Welcome to BookHive</h1>
            <p className="text-xl mb-8">Your social platform for book lovers</p>
            <div className="space-x-4">
              <a href="/auth/register" className="btn-secondary">Get Started</a>
              <a href="/recommendations" className="btn-primary">Explore Books</a>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="card">
              ...
              <p className="text-gray-600">Find your next favorite book with personalized recommendations.</p>
            </div>
            ...
            <div className="card">
              ...
              <h2 className="text-2xl font-bold mb-4">Join Book Clubs</h2>
              <p className="text-gray-600">Connect with other readers in virtual book clubs.</p>
            </div>
            ...
            <div className="card">
              ...
              <p className="text-gray-600">Write reviews and share your reading journey.</p>
            </div>
          </div>
        </div>
      </section>
